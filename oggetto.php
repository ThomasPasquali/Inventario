<?php 
	...
	$oggetto = $c->db->ql('SELECT * FROM '.$c->getNameTableOggetti().' WHERE ID = ?', [$_REQUEST['id']])[0];
...
<html>
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() { $.getScript("js/oggetto.js"); });
		</script>
			...
			<div class="row align-items-center">
				...
				<div class="col">
					...
					<div class="container">
						...
						<div class="row">
							<button type="button" onclick="removeImage(selectedIndex);">Elimina immagine selezionata</button>
							<?php //TODO aggiunta immagine ?>
						</div>
					</div>
